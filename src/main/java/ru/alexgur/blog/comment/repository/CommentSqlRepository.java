...
@Repository
public class CommentSqlRepository extends BaseRepository<Comment> implements CommentStorage {
    ...
    @Autowired
    public CommentSqlRepository(NamedParameterJdbcTemplate njdbc, CommentRowMapper mapper) {
        super(njdbc, mapper);
    }
